...
String URL = "http://192.168.169.185/horus/ESP/esp_conection_qr.php";
...
<html>
  ...
  <body>
    ...
    <h3>Sistema de Exibição e Transmissão Hórus</h3>
    ...
    <div style="padding: 5px; border: 3px solid rgb(255, 193, 7); text-align: center; width: 70%; margin: auto; color:rgb(255, 193, 7);" id="showqrcodeval"></div>
...
//Programação para enviar a informação para o site

if (QRCodeResult != QRCodeResultA){
  String postData = "qrresult=" + String(QRCodeResult); 
